...
CPlay2Scene::CPlay2Scene(LPDIRECT3DDEVICE9 pGraphicDev)
	:
	CScene(pGraphicDev)
{
}

CPlay2Scene::CPlay2Scene(const CPlay2Scene & rhs)
	:
	CScene(rhs)
{
}

CPlay2Scene::~CPlay2Scene(void)
{
}

//LRESULT CPlay2Scene::OnProcessingWindowMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
//{
//	
//	return LRESULT();
//}

void CPlay2Scene::ResetScene(void)
{

}

HRESULT CPlay2Scene::Ready(void)
{
...
int CPlay2Scene::Update(const _float& fTimeDelta)
{
...
{
	CPlay2Scene*	pInstance = new CPlay2Scene(pGraphicDev);
...
HRESULT CPlay2Scene::Ready_Environment_Layer(const _tchar * pLayerTag)
{
...
HRESULT CPlay2Scene::Ready_Resource(Engine::RESOURCETYPE eType)
{
	return S_OK;
}

void CPlay2Scene::Free(void)
{
	//Engine::CCollisionMgr::GetInstance()->ClearGameObjectList();
	CScene::Free();
}
