...
#define MINIGRUNT_COGNITIVE_RANGE 20.f
#define MINIGRUNT_ATTACK_RANGE	5.0f
#define	MINIGRUNT_RUN_SPEED		5.f
#define MINIGRUNT_MAX_HP			10.f

#define BOLTERFLY_COGNITIVE_RANGE 20.f
#define BOLTERFLY_ATTACK_RANGE	2.0f
